...
namespace SGEEP.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ResetPassword(string userId, string dummy)
        {
            ...
            var novaPassword = PasswordGenerator.GerarTemporaria();
            ...
            if (!string.IsNullOrEmpty(user.Email))
                await _emailService.EnviarAsync(user.Email,
                    ...
                    EmailTemplates.Envolver(
                        ...
                        EmailTemplates.TabelaCredenciais(user.Email!, novaPassword) +
                        EmailTemplates.CaixaAviso("Deverá alterar a password no próximo acesso.") +
